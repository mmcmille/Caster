...
'''
	#removes top record from VH Record Properties, Associated Materials
	"clear material": R(Mouse("(124,386), left")#Associated Materials
		+ Pause("50")
		+ Mouse("(30,427), left")#First Record
		+ Pause("50")
		+ Key("apps/120, d/40, enter/80, enter")#Delete and confirm
		+ Pause("100")
		+ Mouse("(1725,723), left"),#OK
		+ Pause("200")
		),
'''
...
def get_rule():
	...
	return SpiritAppstreamRule, RuleDetails(name="spirit appstream", title="Syngenta Appstream Desktop")#executable="appstreamclient") #Appstream
